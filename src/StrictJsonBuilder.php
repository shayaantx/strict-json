...
class StrictJsonBuilder
{
    ...
    public function addParameterAlias(string $classname, string $parameter, string $json_name)
    {
        if (!class_exists($classname)) {
            throw new InvalidArgumentException("Type \"$classname\" is not a valid class", JsonPath::root());
        }
